...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container">
    ...
    <img src="https://myphotos-in-s3.s3.ap-south-1.amazonaws.com/IPS/WhatsApp+Image+2019-07-10+at+11.54.20+PM.jpeg
"style="width:20%;" class="w3-round"><br><br>
    <h4><b>blog by Akhilesh</b></h4>
...
" style="width:80px;" class="w3-circle w3-right w3-margin w3-hide-large w3-hover-opacity"></a>
    ...
    <div class="w3-container">
    <h1><b>Telangana tourism                                                                        Jocata</b></h1>
